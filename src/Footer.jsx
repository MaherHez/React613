  ...
  return (
    <>
      ...
      <StyledFooter>
        ...
        <StyledFooterIcons>
          {footerData.map(data => <StyledLinkIcon href={data.to} key={data.id} >{data.icon}</StyledLinkIcon>)}
          <a href={cv} download="Maher-Hezam-CV">
          <ContactFunButtonStyled>Resumé</ContactFunButtonStyled></a>
        </StyledFooterIcons>
      </StyledFooter>
